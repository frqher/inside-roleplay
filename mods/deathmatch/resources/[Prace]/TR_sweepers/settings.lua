jobSettings = {
    name = "Sokak Temizleme İşi",
    desc = "İş, San Andreas sokaklarını temizlemeyi içerir, özellikle San Fierro şehrini.\nİşi başladıktan sonra, Sweeper marka aracın direksiyonuna geçecek ve bu şehri giderek rahatsız eden kir dalgasıyla mücadeleye başlayacaksın. Görevin, şehrin tüm sokaklarında dolaşan çöpleri toplamak olacak.",
    -- require = "B sınıfı ehliyet\nDeneyim: 30 puan",
    earnings = "Bağlı",

    upgrades = {
        {
            name = "Daha Büyük Kapasite",
            desc = "Aynı anda daha fazla çöp alabilirsin.",
            price = 650,
            type = "sweeper",
        },
        {
            name = "Kirli Şehir",
            desc = "Rotanda daha fazla çöp belirecek.",
            price = 1400,
            type = "trash",
