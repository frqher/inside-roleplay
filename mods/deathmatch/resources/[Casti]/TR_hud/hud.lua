...
function HUD:renderRaceGUI()
	if settings.hudRaceMode == "Sprint" or settings.hudRaceMode == "Drag" then
		drawTextShadowed("YARIŞ ZAMANI", guiInfo.hud.x, guiInfo.hud.y, guiInfo.hud.x + guiInfo.hud.w + 80/zoom, guiInfo.hud.y, tocolor(255, 255, 255, 255), 1/zoom, self.fonts.money, "right", "bottom")
		...
		drawTextShadowed("ROTA YÜZDESİ", guiInfo.hud.x, guiInfo.hud.y, guiInfo.hud.x + guiInfo.hud.w + 80/zoom, guiInfo.hud.y + 115/zoom, tocolor(255, 255, 255, 255), 1/zoom, self.fonts.money, "right", "bottom")
	...
	elseif settings.hudRaceMode == "Okrążenia" then
		...
		drawTextShadowed("EN İYİ RAP", guiInfo.hud.x, guiInfo.hud.y, guiInfo.hud.x + guiInfo.hud.w + 80/zoom, guiInfo.hud.y + 115/zoom, tocolor(255, 255, 255, 255), 1/zoom, self.fonts.money, "right", "bottom")
		dxDrawImage(guiInfo.hud.x + guiInfo.hud.w - 120/zoom + 1, guiInfo.hud.y + 117/zoom + 1, 200/zoom, 4/zoom, "files/images/hud/separator.png", 0, 0, 0, tocolor(0, 0, 0, 40))
		dxDrawImage(guiInfo.hud.x + guiInfo.hud.w - 120/zoom, guiInfo.hud.y + 117/zoom, 200/zoom, 4/zoom, "files/images/hud/separator.png", 0, 0, 0, tocolor(255, 255, 255, 255))
		if settings.hudRaceDetails then
		...
		drawTextShadowed("TECAVÜZ SAYISI", guiInfo.hud.x, guiInfo.hud.y, guiInfo.hud.x + guiInfo.hud.w + 80/zoom, guiInfo.hud.y + 230/zoom, tocolor(255, 255, 255, 255), 1/zoom, self.fonts.money, "right", "bottom")
	...
	elseif settings.hudRaceMode == "Drift" then
		...
		drawTextShadowed("PUAN MİKTARI", guiInfo.hud.x, guiInfo.hud.y, guiInfo.hud.x + guiInfo.hud.w + 80/zoom, guiInfo.hud.y + 115/zoom, tocolor(255, 255, 255, 255), 1/zoom, self.fonts.money, "right", "bottom")
		dxDrawImage(guiInfo.hud.x + guiInfo.hud.w - 120/zoom + 1, guiInfo.hud.y + 117/zoom + 1, 200/zoom, 4/zoom, "files/images/hud/separator.png", 0, 0, 0, tocolor(0, 0, 0, 40))
		dxDrawImage(guiInfo.hud.x + guiInfo.hud.w - 120/zoom, guiInfo.hud.y + 117/zoom, 200/zoom, 4/zoom, "files/images/hud/separator.png", 0, 0, 0, tocolor(255, 255, 255, 255))
		if settings.hudRaceDetails then
...
function HUD:renderGUI()
	...
	if currentWeapon and fileExists(string.format("files/images/weapons/%d.png", currentWeapon)) then
		if weaponWithoutAmmo[currentWeapon] then
			...
			drawTextHardShadowed("Mermi", sx - 60/zoom, guiInfo.hud.y + (guiInfo.bar.h + 14/zoom) * i + 40/zoom, guiInfo.hud.x + guiInfo.bar.w + guiInfo.bar.h + 10/zoom, guiInfo.hud.y + guiInfo.hud.h, tocolor(200, 200, 200, 255 * settings.alpha), 1/zoom, self.fonts.role, "right", "top")
		...
		if plr ~= localPlayer then
			...
			if psx and psy and dist < 30 and clear then
				...
				if not hasMask then
					...
					drawTextShadowed(string.format("%s%s", color, name), psx, psy, psx, psy, tocolor(255, 255, 255, plrAlpha * alpha * settings.alpha), 1 - dist/30, self.fonts.name, "center", "center", false, false, false, true, plrAlpha/255)
					drawTextShadowed("(Kar Maskesi)", psx, psy + 20/zoom - 20/zoom * dist/30, psx, psy + 20/zoom - 20/zoom * dist/30, tocolor(120, 130, 138, plrAlpha * alpha * settings.alpha), 1 - dist/30, self.fonts.role, "center", "center", false, false, false, true, plrAlpha/255)
				end
...
function HUD:renderStandardSpeedometer(alpha)
	...
	dxDrawText("Benzin", guiInfo.speedo.x - 8/zoom, 0, guiInfo.speedo.x - 8/zoom, guiInfo.speedo.y + guiInfo.speedo.h - 64/zoom, tocolor(255, 255, 255, 255 * alpha), 1/zoom, self.fonts.speedo, "center", "bottom")
	...
	if isElementFrozen(guiInfo.speedo.vehicle) then
...
function HUD:renderSuperSpeedometer(alpha)
	...
	elseif guiInfo.speedo.section == 2 then
		...
		dxDrawText("Mevcut kilometre:", guiInfo.speedo.x, guiInfo.speedo.y + 135/zoom, guiInfo.speedo.x + guiInfo.speedo.w, guiInfo.speedo.y + guiInfo.speedo.h, tocolor(207, 208, 222, 200 * alpha), 1/zoom, self.fonts.speedo, "center", "top")
	...
	elseif guiInfo.speedo.section == 3 then
		...
		dxDrawText("Yakıt:", guiInfo.speedo.x, guiInfo.speedo.y + 135/zoom, guiInfo.speedo.x + guiInfo.speedo.w, guiInfo.speedo.y + guiInfo.speedo.h, tocolor(207, 208, 222, 200 * alpha), 1/zoom, self.fonts.speedo, "center", "top")
	...
	dxDrawText("X - bilgi değişikliği\nC - seyir kontrolü", guiInfo.speedo.x, guiInfo.speedo.y + 230/zoom, guiInfo.speedo.x + guiInfo.speedo.w, guiInfo.speedo.y + guiInfo.speedo.h, tocolor(207, 208, 222, 100 * alpha), 1/zoom, self.fonts.info, "center", "top")
end
...
function HUD:renderMotorbikeSpeedometer(alpha)
	...
	dxDrawText("VİTES", guiInfo.speedo.x + 345/zoom, guiInfo.speedo.y + 118/zoom, guiInfo.speedo.x + guiInfo.speedo.w - 70/zoom, guiInfo.speedo.y + guiInfo.speedo.h, tocolor(80, 80, 80, 255 * alpha), 1/zoom, self.fonts.info, "right", "top")
...
function HUD:renderSpeedometerWater(alpha)
	...
	dxDrawText("SU", guiInfo.speedo.x - 138/zoom, 0, guiInfo.speedo.x - 138/zoom, guiInfo.speedo.y + guiInfo.speedo.h - 64/zoom, tocolor(255, 255, 255, 255 * alpha), 1/zoom, self.fonts.speedo, "center", "bottom")
...
function HUD:checkHourGift()
	...
	if (getTickCount() - self.giftTick)/3600000 > 1 then
		...
		if data.premium then
			...
			exports.TR_noti:create(string.format("Ödül kazandınız, $%d.", self.giftCount, data.premium == "diamond" and 500 or 200), "money", 7)
