...
function RacePanel:constructor()
    ...
    self.buttons = {}
    self.buttons.exit = exports.TR_dx:createButton((sx - 250/zoom)/2, guiInfo.y + guiInfo.h - 50/zoom, 250/zoom, 40/zoom, "Kapalı")
    self.buttons.back = exports.TR_dx:createButton(guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + guiInfo.h - 50/zoom, 250/zoom, 40/zoom, "Geri")
    self.buttons.create = exports.TR_dx:createButton(guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + guiInfo.h - 50/zoom, 250/zoom, 40/zoom, "Oluştur")

    self.buttons.removeDeclineCenter = exports.TR_dx:createButton(guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 230/zoom, 250/zoom, 40/zoom, "İptal", "red")
    self.buttons.removeAcceptCenter = exports.TR_dx:createButton(guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 230/zoom, 250/zoom, 40/zoom, "Sil", "green")

    self.edits = {}
    self.edits.findMap = exports.TR_dx:createEdit(guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + guiInfo.h - 50/zoom, 250/zoom, 40/zoom, "Harita / Oyuncu Adı")
...
function RacePanel:render()
    ...
    if self.tab == "getPrice" then
        dxDrawText("Yarış ödülü", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")
        ...
        if not self.renderTable then
            ...
            dxDrawText("Ödüller yükleniyor...", guiInfo.x, guiInfo.y + 220/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
            ...
            dxDrawText(string.format("Popülerliği %d'den fazla olan yarışlara ödüller verilir. Ödülü popüler bir haritanın yaratıcısı olarak veya TOP3'ten bir kişi olarak alabilirsiniz. En iyi zamanların sıfırlanmasıyla birlikte Pazar gününden Pazartesi gününe kadar gece yarısı verilir.", RaceData.minPopularity), guiInfo.x + 10/zoom, guiInfo.y + 250/zoom, guiInfo.x + guiInfo.w - 10/zoom, guiInfo.y + guiInfo.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.data, "center", "top", true, true)
        end

    elseif self.tab == "main" then
        dxDrawText("Yarış paneli", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")
        ...
        if self:isMouseInPosition(guiInfo.x + 50/zoom, guiInfo.y + 90/zoom, 148/zoom, 200/zoom) then
            ...
            dxDrawText("Yarışı başlat", guiInfo.x + 60/zoom, guiInfo.y + 260/zoom, guiInfo.x + 188/zoom, guiInfo.y + 50/zoom, tocolor(255, 255, 255, 255 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        else
            ...
            dxDrawText("Yarışı başlat", guiInfo.x + 60/zoom, guiInfo.y + 260/zoom, guiInfo.x + 188/zoom, guiInfo.y + 50/zoom, tocolor(255, 255, 255, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        end
        if self:isMouseInPosition(guiInfo.x + guiInfo.w/2 - 74/zoom, guiInfo.y + 90/zoom, 148/zoom, 200/zoom) then
            ...
            dxDrawText("Ödüllerinizi toplayın", guiInfo.x + guiInfo.w/2 - 64/zoom, guiInfo.y + 260/zoom, guiInfo.x + guiInfo.w/2 + 64/zoom, guiInfo.y + 50/zoom, tocolor(255, 255, 255, 255 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        else
            ...
            dxDrawText("Ödüllerinizi toplayın", guiInfo.x + guiInfo.w/2 - 64/zoom, guiInfo.y + 260/zoom, guiInfo.x + guiInfo.w/2 + 64/zoom, guiInfo.y + 50/zoom, tocolor(255, 255, 255, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        end
        if self:isMouseInPosition(guiInfo.x + guiInfo.w - 128/zoom - 70/zoom, guiInfo.y + 90/zoom, 148/zoom, 200/zoom) then
            ...
            dxDrawText("Rota oluştur", guiInfo.x + guiInfo.w - 128/zoom - 60/zoom, guiInfo.y + 260/zoom, guiInfo.x + guiInfo.w - 60/zoom, guiInfo.y + 50/zoom, tocolor(255, 255, 255, 255 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        else
            ...
            dxDrawText("Rota oluştur", guiInfo.x + guiInfo.w - 128/zoom - 60/zoom, guiInfo.y + 260/zoom, guiInfo.x + guiInfo.w - 60/zoom, guiInfo.y + 50/zoom, tocolor(255, 255, 255, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        end

    -- Create own track
    elseif self.tab == "create" then
        dxDrawText("Rotalar", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")
        ...
        if not self.renderTable then
            ...
            dxDrawImage((sx - 64/zoom)/2, guiInfo.y + 145/zoom, 64/zoom, 64/zoom, "files/images/loading.png", self.rot, 0, 0, tocolor(170, 170, 170, 200 * self.alpha))
            dxDrawText("Rotalar yükleniyor...", guiInfo.x, guiInfo.y + 220/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        else
            ...
            if #self.renderTable > 0 then
                for i, v in pairs(self.renderTable) do
                    ...
                    dxDrawText(string.format("Oluşturuldu: #aaaaaa%s", v.created), guiInfo.x + 90/zoom, guiInfo.y + 73/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                    dxDrawText(string.format("Popülerlik: #aaaaaa%s", v.trackPopularity or 0), guiInfo.x + 90/zoom, guiInfo.y + 93/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)

                    dxDrawText(string.format("Yarış türü: #aaaaaa%s", v.type), guiInfo.x + 380/zoom, guiInfo.y + 53/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                    dxDrawText(string.format("Araç tipi: #aaaaaa%s", v.vehicleType), guiInfo.x + 380/zoom, guiInfo.y + 73/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                    dxDrawText(string.format("Hız sınırı: #aaaaaa%s", v.vehicleSpeed or 0), guiInfo.x + 380/zoom, guiInfo.y + 93/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                end
            else
                dxDrawText("Henüz herhangi bir rota oluşturmadınız.", guiInfo.x, guiInfo.y + 180/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
            end
        end

    elseif self.tab == "createSettings" then
        dxDrawText("Rota oluşturma", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")

        dxDrawText("Yarış türü", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 60/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "top")
        ...
        if guiInfo.raceTypes[self.selectedRaceType] == "Turlar" then
            dxDrawText("Tur sayısı", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 130/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "top")
            ...
            dxDrawText("Tur sayısı", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 130/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 120 * self.alpha), 1/zoom, self.fonts.main, "center", "top")
        ...
        dxDrawText("Araç tipi", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 200/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "top")
        ...
        if guiInfo.vehicleTypes[self.selectedVehicleType] == "Prywatny" then
            dxDrawText("Hız sınırı", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 272/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "top")
            ...
            dxDrawText("Hız sınırı", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 272/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 120 * self.alpha), 1/zoom, self.fonts.main, "center", "top")
        ...
        dxDrawText("Rotanızın başlangıç ​​noktasını seçin.", guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 310/zoom, guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 120 * self.alpha), 1/zoom, self.fonts.minimap, "center", "top", false, true)
    ...
    elseif self.tab == "race" then
        dxDrawText("Yarış seçimi", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")
        ...
        if not self.renderTable then
            ...
            dxDrawImage((sx - 64/zoom)/2, guiInfo.y + 145/zoom, 64/zoom, 64/zoom, "files/images/loading.png", self.rot, 0, 0, tocolor(170, 170, 170, 200 * self.alpha))
            dxDrawText("Rota listesinin yüklenmesi...", guiInfo.x, guiInfo.y + 220/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        ...
        elseif #self.renderTable > 0 then
            for i = 1, 4 do
                ...
                if v then
                    ...
                    dxDrawText(string.format("Yarış türü: #aaaaaa%s", v.type), guiInfo.x + 380/zoom, guiInfo.y + 53/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                    dxDrawText(string.format("Yarış türü: #aaaaaa%s", v.vehicleType), guiInfo.x + 380/zoom, guiInfo.y + 73/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                    dxDrawText(string.format("Hız sınırı: #aaaaaa%s", v.vehicleSpeed or 0), guiInfo.x + 380/zoom, guiInfo.y + 93/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                end
            end
            ...
            if self.raceMapsLoading then
                ...
                dxDrawText("Rotalar yükleniyor...", guiInfo.x + 270/zoom, guiInfo.y + guiInfo.h - 110/zoom, guiInfo.x + guiInfo.w, guiInfo.y + guiInfo.h - 78/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "left", "center")
            end
            ...
            dxDrawText(self.searchText and self.searchText or "Henüz rota oluşturulmadı.", guiInfo.x, guiInfo.y + 180/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        end
        self:checkSearchEdit()

    elseif self.tab == "pickVehicle" then
        dxDrawText("Araç seçimi", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")
        ...
        if not self.renderTable then
            ...
            dxDrawImage((sx - 64/zoom)/2, guiInfo.y + 145/zoom, 64/zoom, 64/zoom, "files/images/loading.png", self.rot, 0, 0, tocolor(170, 170, 170, 200 * self.alpha))
            dxDrawText("Araç listesinin yüklenmesi...", guiInfo.x, guiInfo.y + 220/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        ...
        elseif #self.renderTable > 0 then
            for i = 1, 4 do
                ...
                dxDrawText(string.format("Motor: #aaaaaa%s", data.engine), guiInfo.x + 90/zoom, guiInfo.y + 93/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                ...
                dxDrawText(string.format("Azami hız: #aaaaaa%skm/h", data.maxSpeed or 0), guiInfo.x + 380/zoom, guiInfo.y + 73/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)

                if self.trackDetails.vehicleSpeed == "Sınırsız" then
                    dxDrawText("Bu yarışta mevcut: #aaaaaaTAK", guiInfo.x + 380/zoom, guiInfo.y + 93/zoom + 72/zoom * (i-1), guiInfo.x + 200/zoom, guiInfo.y + 50/zoom + 72/zoom * i, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                else
            ...
            dxDrawText(self.searchText and self.searchText or "Herhangi bir özel aracınız yok.", guiInfo.x, guiInfo.y + 180/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")
        end
        self:checkSearchEdit()

    elseif self.tab == "raceDetails" or self.tab == "raceStart" then
        dxDrawText("Yarış ayrıntıları", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")
        ...
        if not self.trackDetails then
            ...
            dxDrawImage((sx - 64/zoom)/2, guiInfo.y + 145/zoom, 64/zoom, 64/zoom, "files/images/loading.png", self.rot, 0, 0, tocolor(170, 170, 170, 200 * self.alpha))
            dxDrawText("Rota verileri yükleniyor...", guiInfo.x, guiInfo.y + 220/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 200 * self.alpha), 1/zoom, self.fonts.category, "center", "top")

        else
            dxDrawText("Rota bilgileri:", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 60/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.main, "left", "top", false, false, false, true)
            dxDrawText(string.format("Yarış türü: #aaaaaa%s", self.trackDetails.type), guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 90/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
            if self.trackDetails.type == "Turlar" then
                dxDrawText(string.format("Tur sayısı: #aaaaaa%s", self.trackDetails.laps), guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 115/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
            else
                dxDrawText(string.format("Tur sayısı: #aaaaaa%s", self.trackDetails.laps), guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 115/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 120 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
            end
            dxDrawText(string.format("Araç tipi: #aaaaaa%s", self.trackDetails.vehicleType), guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 140/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
            if self.trackDetails.vehicleType == "Prywatny" then
                dxDrawText(string.format("Hız sınırı: #aaaaaa%s", self.trackDetails.vehicleSpeed), guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 165/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
            else
                dxDrawText(string.format("Hız sınırı: #aaaaaa%s", self.trackDetails.vehicleSpeed), guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 165/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 120 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
            end
            dxDrawText(string.format("Popülerlik: #aaaaaa%s", self.trackDetails.trackPopularity or 0), guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 190/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)

            if self.trackDetails.type == "Drift" then
                dxDrawText("En çok puan:", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 235/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.main, "left", "top", false, false, false, true)
            else
                dxDrawText("En iyi zamanlar:", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 235/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.main, "left", "top", false, false, false, true)
            end
            ...
            if self.trackDetails.bestTimes then
                if self.trackDetails.bestTimes[1].username then
                    ...
                    dxDrawText("Bu rotada zaman yok", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 265/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
                end
            else
                dxDrawText("Bu rotada zaman yok", guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 265/zoom, guiInfo.x + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.data, "left", "top", false, false, false, true)
            end
            ...
            if self.trackDetails.startPos then
                ...
                if self.trackDetails.type ~= "Turlar" then
                    ...
                    dxDrawText("#dc2828Kırmızı işaretleyici #dcdcdc- başla\n#2b80ffMavi işaretleyici #dcdcdc- bitir.", guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 310/zoom, guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 120 * self.alpha), 1/zoom, self.fonts.minimap, "center", "top", false, false, false, true)
                else
                    dxDrawText("#dc2828Ckırmızı işaretleyici #dcdcdc- başla ve bitir.", guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 320/zoom, guiInfo.x + guiInfo.w/2 + (guiInfo.w/2 + 250/zoom)/2, guiInfo.y + 50/zoom, tocolor(220, 220, 220, 120 * self.alpha), 1/zoom, self.fonts.minimap, "center", "top", false, false, false, true)
                end
            end
        end

    elseif self.tab == "trackRemove" then
        dxDrawText("Rotayı silme", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")

        dxDrawText("Bu rotayı silmek istediğinizden emin misiniz?\n#a3281fBu işlem geri alınamaz.", guiInfo.x, guiInfo.y + 310/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.category, "center", "center", false, false, false, true)
...
function RacePanel:performTrachSearch(text)
    if string.find(text, "#") then
        ...
        self.searchText = "Böyle bir rota bulunamadı."
    ...
    elseif string.len(text) < 1 then
        ...
        self.searchText = "Oyuncu henüz herhangi bir rota oluşturmadı."
    end
...
function RacePanel:selectTab(tab, details)
    ...
    elseif tab == "create" then
        ...
        exports.TR_dx:setButtonText(self.buttons.create, "Yeni bir tane oluştur")
        self:loadData("create")
        self.mainTab = tab

    elseif tab == "getPrice" then
        exports.TR_dx:setButtonVisible({self.buttons.back, self.buttons.create}, true)
        exports.TR_dx:setButtonText(self.buttons.create, "Ödüllerinizi toplayın")
        self:loadData("getPrice")

    elseif tab == "createSettings" then
        exports.TR_dx:setButtonVisible({self.buttons.back, self.buttons.create}, true)
        exports.TR_dx:setButtonText(self.buttons.create, "Sonraki")
    ...
    elseif tab == "raceDetails" then
        exports.TR_dx:setButtonVisible({self.buttons.back, self.buttons.create}, true)
        exports.TR_dx:setButtonText(self.buttons.create, "Rotayı silme")
        self:loadData("raceDetails", details)

    elseif tab == "raceStart" then
        exports.TR_dx:setButtonVisible({self.buttons.back, self.buttons.create}, true)
        exports.TR_dx:setButtonText(self.buttons.create, "Yarışı başlat")
...
function RacePanel:response(data, type)
    ...
    if type == "playerNotFound" then
        self.searchText = "Böyle oyuncu bulunamadı."
        self.renderTable = {}
    ...
    elseif self.tab == "race" then
        if type then
            ...
            if self.loadedRaceTracks < self.toLoad + 10 then
                exports.TR_noti:create("Mevcut tüm rotalar yüklendi.", "success")
            end
    ...
    elseif self.tab == "getPrice" then
        ...
        if type then exports.TR_noti:create("Ödüller başarıyla alındı.", "success") end
...
function RacePanel:onClientClick(btn, state)
    ...
    elseif self.tab == "createSettings" then
        ...
        elseif self:isMouseInPosition(guiInfo.x + (guiInfo.w/2 + 250/zoom)/2 - 24/zoom, guiInfo.y + 144/zoom, 24/zoom, 24/zoom) and guiInfo.raceTypes[self.selectedRaceType] == "Turlar" then
            self.selectedRaceLaps = math.min(self.selectedRaceLaps + 1, 9)

        elseif self:isMouseInPosition(guiInfo.x + (guiInfo.w/2 - 250/zoom)/2, guiInfo.y + 144/zoom, 24/zoom, 24/zoom) and guiInfo.raceTypes[self.selectedRaceType] == "Turlar" then
...
function RacePanel:buttonClick(btn)
    ...
    elseif btn == self.buttons.create then
        if self.tab == "create" then
            if self.loadedData["create"] then
                if #self.loadedData["create"] >= 4 then
                    exports.TR_noti:create("Oluşturabileceğiniz rotaların sınırına ulaştınız.", "error")
                    return
                end
            end
        ...
        elseif self.tab == "getPrice" then
            if not self.renderTable then return end
            if self.renderTable < 1 then exports.TR_noti:create("Alacağınız bir ödül yok.", "error") return end
            exports.TR_dx:setResponseEnabled(true)
        ...
        elseif self.tab == "raceStart" then
            ...
            if isAdmin and not isDev then exports.TR_noti:create("İdari görevdeyken yarış başlatamazsınız.", "error") return end
            ...
            if self.trackDetails.vehicleType == "Prywatny" then
                ...
                self.blockSearch = true
                exports.TR_dx:showLoading(900000, "Yarış yükleniyor")
                ...
                setTimer(function()
                    ...
                    elseif self.trackDetails.type == "Turlar" then
                        exports.TR_hud:updateRaceDetails({
                            lap = 1,
                            laps = self.trackDetails.laps,
                        })
        ...
        elseif self.tab == "pickVehicle" then
            if not self.selectedVehicle then exports.TR_noti:create("Hiçbir araç seçilmedi.", "error") return end
            if self.trackDetails.vehicleSpeed == "Sınırsız" then
                self.blockSearch = true
                exports.TR_dx:showLoading(900000, "Yarış yükleniyor")
...
function RacePanel:startTrackCreation()
    if not self.selectedMinimapPos then exports.TR_noti:create("Devam etmek için önce bir başlangıç ​​noktası seçmelisiniz.", "info") return end

    exports.TR_dx:showLoading(999999, "Başlangıç ​​alanının kontrol edilmesi")
    exports.TR_dx:setResponseEnabled(true)
...
function createRaceMarkers()
    for i, v in pairs(RaceData.markerPos) do
        ...
        setElementData(marker, "markerData", {
            title = "Araç yarışı",
            desc = "Bir yarış başlatmak veya kendi rotanızı oluşturmak için işaretçiyi girin.",
        }, false)
