...
function SignSystem:renderNoVehicle(...)
    ...
    if arg[2] == 3927 then
        ...
        dxDrawText("Stokta araç yok!", 5, 5, gui.w - 5, gui.h - 5, tocolor(20, 20, 20, 255), 1, self.fonts.big, "center", "center", true, true)
    else
        dxDrawRectangle(0, 0, gui.w, gui.h, tocolor(31, 78, 153, 255))
        dxDrawText("Araç stokta yok.", 5, 5, gui.w - 5, gui.h - 5, tocolor(217, 28, 28, 255), 1, self.fonts.price, "center", "top", true, true)
        dxDrawText("Yakında yeni bir kopyası burada olacak.", 5, 88, gui.w - 5, gui.h - 5, tocolor(220, 220, 220, 255), 1, self.fonts.model, "center", "top", true, true)
        dxDrawText("Verdiğimiz rahatsızlıktan dolayı özür dileriz!", 5, 5, gui.w - 5, gui.h - 10, tocolor(220, 220, 220, 255), 1, self.fonts.seller, "center", "bottom", true, true)
    end
...
function SignSystem:renderOldSign(sign, signModel, data, veh)
    ...
    dxDrawText("Fiyat:", 5, 60, gui.w - 5, gui.h - 5, tocolor(20, 20, 20, 255), 1, self.fonts.price, "center", "top", true, true)
...
function SignSystem:renderStandardSign(sign, signModel, data, veh)
    ...
    if petrolType == "p" then petrolType = "Benzin" end
    if petrolType == "d" then petrolType = "Dizel" end
    if petrolType == "b" then petrolType = "İsteğe bağlı" end

    dxSetRenderTarget(self.signs[sign].texture)
    dxDrawRectangle(0, 0, gui.w, gui.h, tocolor(31, 78, 153, 255))
    dxDrawText(self:getVehicleName(model), 5, 2, gui.w - 5, 40, tocolor(255, 255, 255, 255), 1, self.fonts.model, "center", "center", true, true)

    dxDrawText("Tank:", 5, 40, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    dxDrawText("Motor:", 5, 55, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    dxDrawText("V-max:", 5, 70, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    dxDrawText("Yakıt:", 5, 85, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    dxDrawText("Yanma:", 5, 100, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    dxDrawText("Renk:", 5, 115, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    dxDrawText("Lamba rengi:", 5, 130, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    dxDrawText("P. Stilistik:", 5, 145, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "left", "top", true, true)
    ...
    dxDrawText("Standart", 5, 115, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "right", "top", true, true)
    dxDrawText("Beyaz", 5, 130, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "right", "top", true, true)
    dxDrawText("Eksiklik", 5, 145, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "right", "top", true, true)

    dxDrawText("Araç başı fiyat:", 5, 5, gui.w - 5, gui.h - 75, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "center", "bottom", true, true)
    dxDrawText("$"..data.price, 5, 5, gui.w - 5, gui.h - 55, tocolor(255, 255, 255, 255), 1, self.fonts.price, "center", "bottom", true, true)

    dxDrawText("Araç başı fiyat", 5, 205, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "center", "top", true, true)
    dxDrawText("İlgili", 5, 215, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "center", "top", true, true)
    dxDrawText("Satın al, konuş", 5, 225, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "center", "top", true, true)
    dxDrawText("Satıcı ile.", 5, 235, gui.w - 5, gui.h, tocolor(255, 255, 255, 255), 1, self.fonts.seller, "center", "top", true, true)
    dxSetRenderTarget()
